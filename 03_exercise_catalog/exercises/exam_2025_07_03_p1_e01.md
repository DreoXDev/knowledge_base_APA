...
> [!Info]
> Questo esercizio e collegato alla metodologia manoscritta in `esercizi APA.pdf`, pagina 11.

- Metodo: [[metodo_programmazione_dinamica_lcs_vincolo_ingombro]]
- Esempio svolto collegato: [[lcs_ingombro_SRC_EXTRA_001]]
- Pattern: [[parte_i_dynamic_programming_patterns]]

## Metodo collegato dagli appunti SRC-NOTE-001

- Metodo: [[dp_lcs_vincolo_somma_ingombro]]
